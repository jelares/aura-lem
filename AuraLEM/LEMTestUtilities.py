...
def analyze_async(event, context):
  ...
  """
    ...
    if not validated:
        return {"statusCode": 500, "body": json.dumps("Failed to generate UDS.")}
    ...
    if uds_put_response["statusCode"] == 200:
        return {"statusCode": 200, "body": json.dumps("Successfully updated UDS.")}

    else:
        return {"statusCode": 500, "body": json.dumps("Failed to update UDS.")}
